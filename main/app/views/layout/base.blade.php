	...
	<div class="notifications bottom-left">
		<div style="float:left; width: 240px;">
			<div class="form-group" style="width: 220px;">
				<a href="http://www.practicepro.co.uk/bizvaluation" target="_blank" title="Create a professional business valuation in just 15 minutes">
					<img src="{{ asset('assets/images/logos/bizval.png') }}" style="margin-left:20px; width: 10%; margin-top:15px; width: 100%;">
				</a>
			</div>
			<div class="form-group" style="width: 200px;">
				<a href="http://www.practicepro.co.uk/virtualfd" target="_blank" title="Help your clients achieve their goals">
					<img src="{{ asset('assets/images/logos/vfd.png') }}" style="margin-left:30px; width: 10%; margin-top: 15px; width: 100%;">
				</a>
			</div>
			<div class="form-group" style="width: 200px;">
				<a href="http://www.practicepro.co.uk/priceplanner" target="_blank" title="Price professionally and create additional fees">
					<img src="{{ asset('assets/images/logos/priceplan.png') }}" style="margin-left:30px; width: 10%; margin-top: 15px; width: 100%;">
				</a>
			</div>
		</div>
	</div>
